...
namespace SiNetProjectManager
{
    public partial class App : Application
    {
        ...
        private static bool EnforceSingleInstance()
        {
            ...
            _mutex = new Mutex(true, "Global\\SiNetProjectManager_UniqueApp", out bool createdNew);
            if (!createdNew)
            {
        ...
        private static string GetLogDirectory()
        {
            try
            {
                ...
                var product = entry?.GetName().Name ?? "SiNetProjectManager";
            ...
            {
                var root = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData);
                return Path.Combine(root, "SiNet", "SiNetProjectManager", "Logs");
            }
        }
    }
