...
public sealed class AppFeatureCodesCoverageTests
{
    ...
    [InlineData(AppRole.Employee, AppFeatureCodes.ShellOpenProjectsDashboard, true)]
    [InlineData(AppRole.Unauthorized, AppFeatureCodes.ShellOpenProjectsDashboard, false)]
    ...
    [InlineData(AppRole.Employee, AppFeatureCodes.WorkflowOpsStart, false)]
    [InlineData(AppRole.Management, AppFeatureCodes.WorkflowOpsStart, true)]
