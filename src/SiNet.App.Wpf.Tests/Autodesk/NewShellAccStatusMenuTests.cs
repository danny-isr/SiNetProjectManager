...
public sealed class NewShellAccStatusMenuTests
{
    ...
    private sealed class StubAccLiveProjectDiscoveryService : IAccLiveProjectDiscoveryService
    {
        public Task<IReadOnlyList<AccHubCatalogEntry>> GetHubsAsync(CancellationToken cancellationToken = default) =>
            Task.FromResult<IReadOnlyList<AccHubCatalogEntry>>([]);
    ...
    private sealed class StubAccLookupSeedService : IAccLookupSeedService
    {
        public Task<IReadOnlyList<AccDocumentLookupSeed>> GetRecentSeedsAsync(CancellationToken cancellationToken = default) =>
            Task.FromResult<IReadOnlyList<AccDocumentLookupSeed>>([]);
    }
