...
/// <c>FloatingInspectionViewModel</c> window yet and is not wired into navigation in this phase.
/// Sub-areas are injected so each can evolve independently and be unit-tested in isolation.
/// </summary>
