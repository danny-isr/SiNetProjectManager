...
Related: [`PRODUCTION_MONITORING.md`](./PRODUCTION_MONITORING.md), [`LOGGING_MATERIAL_FAILURES.md`](./LOGGING_MATERIAL_FAILURES.md) (what must be Warning+ on the share), [`DEV_DIRECTIVE_STARTUP_LOG_WRITE_VERIFY.md`](./DEV_DIRECTIVE_STARTUP_LOG_WRITE_VERIFY.md) (DEV-028), [`DEV_DIRECTIVE_WORKSTATION_SECRETS_AND_HEALTH.md`](./DEV_DIRECTIVE_WORKSTATION_SECRETS_AND_HEALTH.md), [`.cursor/skills/llog-review/SKILL.md`](../.cursor/skills/llog-review/SKILL.md).

---

## 1. Existing mechanism

Live tails and folder layout: [`PRODUCTION_MONITORING.md`](./PRODUCTION_MONITORING.md) §2–3. Central Client files exist only at **Warning+**. After DEV-028 ([`DEV_DIRECTIVE_STARTUP_LOG_WRITE_VERIFY.md`](./DEV_DIRECTIVE_STARTUP_LOG_WRITE_VERIFY.md)) a healthy start **must** leave `[STARTUP] Client process alive` on the UNC (class `client-session-alive`) — not a defect. **1.0.32 did not** (local only).
