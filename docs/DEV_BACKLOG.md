...
| DEV-020 | Monthly bak staging: move to `D:\SharedFolder\ProjectsData\MasterPlanBakup` (PROD Client==Server; no mapped `N:\`), retain 10 | Fixed on release — orphan archive under same root | P1 | [`DEV_PLAN_MASTERPLAN_MONTHLY_CAPTURE.md`](./DEV_PLAN_MASTERPLAN_MONTHLY_CAPTURE.md) §1b | SyncEngine **1.0.26** |
