...
| DEV-003 | ProjectWork tree: `.bak` exclude, hide stale recover, green newer recover, delete stale (not orphans), ignore folders, preserve expand, Collapse all | Planning | P1 (pilot) | [`DEV_PLAN_PROJECTWORK_TREE_BAK_RECOVER.md`](./DEV_PLAN_PROJECTWORK_TREE_BAK_RECOVER.md) | Yes — after slices A–H ship |
