...
| [`DEV_DIRECTIVE_STARTUP_LOG_WRITE_VERIFY.md`](./DEV_DIRECTIVE_STARTUP_LOG_WRITE_VERIFY.md) | **DEV-028:** prove Llog write; Slice E — הערה if Client central min is not Warning |
