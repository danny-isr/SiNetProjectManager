...
| `AiConfiguredCloudModels` | AI Configured Cloud Models | Cloud models | DB | Office | All | Admin | Optional | - | CSV | None | No | - | CSV entries in Provider\|ModelName format | AI | Medium | - | - | - | AiModelCatalogWindow, AI settings / model selection logic | System Admin | No | Active | - |
